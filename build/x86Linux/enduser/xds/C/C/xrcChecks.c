...
/* "@(#)xrcChecks.c Nov 19  1:11:49 2022" */
#include "xrcChecks.h"
#define xrcChecks_C_
#include "xmRTS.h"
...
{
   if ((X2C_INT32)i<0L) X2C_TRAP_F(1L);
   return i;
} /* end X2C_CHKS_F() */
...
{
   if ((X2C_INT32)a<(X2C_INT32)min0 || (X2C_INT32)a>(X2C_INT32)max0) {
      X2C_TRAP_F(1L);
   }
   return a;
} /* end X2C_CHK_F() */
...
{
   if ((X2C_CARD32)a<(X2C_CARD32)min0 || (X2C_CARD32)a>(X2C_CARD32)max0) {
      X2C_TRAP_F(1L);
   }
   return a;
} /* end X2C_CHKU_F() */

...
/* "@(#)xrHistory.c Nov 19  1:11:49 2022" */
#include "xrHistory.h"
#define xrHistory_C_
#include "xmRTS.h"
#include "xPOSIX.h"
...
extern void X2C_show_history(void)
{
   ...
   { /* with */
      ...
      if ((X2C_INT32)anonym->his_cnt>0L && (X2C_INT32)anonym->his_cnt<=254L) {
         anonym->his[(X2C_INT32)anonym->his_cnt-1L].fln = (X2C_INT16)
                X2C_hline;
      }
      if ((X2C_INT32)anonym->his_cnt>255L) {
         printf("History stack was truncated - not enough room.\n");
         anonym->his_cnt = 256;
      }
      while ((X2C_INT32)anonym->his_cnt>0L) {
         --anonym->his_cnt;
...
extern void X2C_PROC_INP_F(X2C_CHAR file[], X2C_INT32 line)
{
   ...
   { /* with */
      struct X2C_Coroutine_STR * anonym = current;
      if ((X2C_INT32)anonym->his_cnt>0L && (X2C_INT32)anonym->his_cnt<=256L) {
         anonym->his[(X2C_INT32)anonym->his_cnt-1L].fln = (X2C_INT16)
                X2C_hline;
      }
      if ((X2C_INT32)anonym->his_cnt<=255L) {
...
extern void X2C_Profiler_clock(void)
{
   ...
   { /* with */
      ...
      if ((X2C_INT32)anonym->his_cnt<=256L && anonym->his[(X2C_INT32)
                anonym->his_cnt-1L].prf) {
         ++anonym->his[(X2C_INT32)anonym->his_cnt-1L].prf->time0;
      }
   }
   ++total_time;
...
extern void X2C_PROC_OUT_F(void)
{
   ...
   { /* with */
      ...
      if ((X2C_INT32)anonym->his_cnt>0L && (X2C_INT32)anonym->his_cnt<=254L) {
         X2C_hline = (X2C_INT32)anonym->his[(X2C_INT32)
                anonym->his_cnt-1L].fln;
      }
   }
} /* end X2C_PROC_OUT_F() */

...
/* "@(#)xrcIncDec.c Nov  7 22:55:49 2022" */
#include "xrcIncDec.h"
#define xrcIncDec_C_
#include "X2C.h"
...
{
   X2C_INT16 i;
   i = (X2C_INT16)((X2C_INT32)(X2C_INT16)(X2C_CARD8)*x+(X2C_INT32)(X2C_INT16)
                y);
...
{
   X2C_INT16 i;
   i = (X2C_INT16)((X2C_INT32)*x+(X2C_INT32)y);
   if ((X2C_INT32)i<(X2C_INT32)min0 || (X2C_INT32)i>(X2C_INT32)max0) {
      X2C_TRAP(1L);
   }
   *x = (X2C_INT8)i;
   return *x;
...
{
   X2C_CARD16 i;
   i = (X2C_CARD16)((X2C_CARD32)*x+(X2C_CARD32)y);
   if ((X2C_CARD32)i<(X2C_CARD32)min0 || (X2C_CARD32)i>(X2C_CARD32)max0) {
      X2C_TRAP(1L);
   }
   *x = (X2C_CARD8)i;
   return *x;
...
extern X2C_CARD8 X2C_DECUS(X2C_CARD8 * x, X2C_CARD8 y, X2C_CARD8 min0,
                X2C_CARD8 max0)
{
   if ((X2C_CARD32)y>(X2C_CARD32)*x) X2C_TRAP(1L);
   *x = (X2C_CARD8)((X2C_CARD32)*x-(X2C_CARD32)y);
   if ((X2C_CARD32)*x<(X2C_CARD32)min0 || (X2C_CARD32)*x>(X2C_CARD32)max0) {
      X2C_TRAP(1L);
   }
   return *x;
} /* end X2C_DECUS() */
...
{
   if ((X2C_CARD32)y>(X2C_CARD32)*x) X2C_TRAP(1L);
   *x = (X2C_CARD16)((X2C_CARD32)*x-(X2C_CARD32)y);
   if ((X2C_CARD32)*x<(X2C_CARD32)min0 || (X2C_CARD32)*x>(X2C_CARD32)max0) {
      X2C_TRAP(1L);
   }
   return *x;

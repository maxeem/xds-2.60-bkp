...
{
   return (X2C_CARD8)(X2C_STRCMP_PROC((X2C_pVOID)s1, s1_len, (X2C_pVOID)s2,
                s2_len)+1);
} /* end Compare() */
...
extern X2C_BOOLEAN Strings_Equal(X2C_CHAR s1[], X2C_CARD32 s1_len,
                X2C_CHAR s2[], X2C_CARD32 s2_len)
{
   return X2C_STRCMP_PROC((X2C_pVOID)s1, s1_len, (X2C_pVOID)s2, s2_len)==0;
} /* end Equal() */
